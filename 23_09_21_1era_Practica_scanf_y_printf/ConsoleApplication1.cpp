...
//En esta práctica se usan las palabras reservadas bool, int, float, double, long double, char, long long int, string al igual que se ve el uso de scanf y printf.
#include <iostream>
using namespace std;
